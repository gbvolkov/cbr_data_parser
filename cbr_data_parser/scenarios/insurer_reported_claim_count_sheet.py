...
EXPECTED_TITLE = "Сведения о количестве заявленных страховых случаев в разрезе страховщиков, единиц"
EXPECTED_DATA_COLUMN_COUNT = 256


def convert_insurer_reported_claim_count_sheet_to_csv_and_json(
    excel_path: Path | str,
    csv_path: Path | str,
    json_path: Path | str,
) -> dict:
