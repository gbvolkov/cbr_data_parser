...
EXPECTED_TITLE = "Сведения о количестве договоров страхования, заключенных в отчетном периоде, в разрезе федеральных округов и субъектов Российской Федерации, ед."
EXPECTED_DATA_COLUMN_COUNT = 41


def convert_regional_contract_count_sheet_to_csv_and_json(
    excel_path: Path | str,
    csv_path: Path | str,
    json_path: Path | str,
) -> dict:
