...
EXPECTED_TITLE = "Сведения о прямом возмещении убытков по обязательному страхованию гражданской ответственности владельцев транспортных средств в разрезе страховщиков"
...
def convert_insurer_osago_direct_reimbursement_sheet_to_csv_and_json(
    excel_path: Path | str,
    csv_path: Path | str,
    json_path: Path | str,
) -> dict:
