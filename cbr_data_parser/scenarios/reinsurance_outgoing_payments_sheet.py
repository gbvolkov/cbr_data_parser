...
EXPECTED_TITLE = "Сведения о cтраховых выплатах по договорам исходящего перестрахования в разрезе страховщиков, тыс руб."


def convert_reinsurance_outgoing_payments_sheet_to_csv_and_json(
    excel_path: Path | str,
    csv_path: Path | str,
    json_path: Path | str,
) -> dict:
